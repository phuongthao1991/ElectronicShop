...
namespace ElectronicShop.Controllers
{
    public class OrderDetailsController : BaseController
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,OrderId,ProductId,Quantity,Price")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,OrderId,ProductId,Quantity,Price")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
